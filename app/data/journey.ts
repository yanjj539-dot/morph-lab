...
export const JOURNEY_STAGES: readonly JourneyStage[] = [
  {
    ...
    fallbackSrc: withBasePath("/fallback/round-3/observe.webp"),
  },
  {
    id: "structure",
    label: "02",
    ...
    fallbackSrc: withBasePath("/fallback/round-3/structure.webp"),
  },
  {
    id: "prototype",
    label: "03",
    ...
    fallbackSrc: withBasePath("/fallback/round-3/prototype.webp"),
  },
  {
    id: "release",
    label: "04",
    ...
    fallbackSrc: withBasePath("/fallback/round-3/release.webp"),
  },
] as const;
