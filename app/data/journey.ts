...
export const JOURNEY_STAGES: readonly JourneyStage[] = [
  {
    ...
    fallbackSrc: withBasePath("/fallback/round-4/observe.webp"),
  },
  {
    id: "structure",
    label: "02",
    ...
    fallbackSrc: withBasePath("/fallback/round-4/structure.webp"),
  },
  {
    id: "prototype",
    label: "03",
    ...
    fallbackSrc: withBasePath("/fallback/round-4/prototype.webp"),
  },
  {
    id: "release",
    label: "04",
    ...
    fallbackSrc: withBasePath("/fallback/round-4/release.webp"),
  },
] as const;
